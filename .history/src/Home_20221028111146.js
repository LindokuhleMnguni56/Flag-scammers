import { StyleSheet, Text, View, TextInput, SafeAreaView, TouchableOpacity,TouchableHighlight, ScrollView, Modal, Touchable } from 'react-native';
                ...
                flags.map(flag => ((
                  <View style={styles.cardsContainer} key={flag.id}>
                    <View style={styles.card}>
                      ...
                      <Ionicons
          name={flag.upvoted ? 'md-heart' : 'md-heart-empty'}
          size={20}
          color="#ff6347"
        />
