  ...
  return (
    ...
    <View  style={styles.container}>
     {user != null ?(<RedPart2 />):(<RedPart />)} 
      ...
      <FontAwesomeIcon icon={faUser} style={{color="blue" secondaryColor="red" secondaryOpacity={ 0.4 }backgroundColor:'black',width:170,height:170,borderRadius:50,color:'white', marginLeft:5}} />    
