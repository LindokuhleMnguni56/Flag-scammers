    ...
    const addflag = async()=>{
        // if (user!=null){
            ...
            // console.log("New Flag  ID: ", docRef.flag.uid);
             await addDoc(itemRef,{address:mail ,addressType:selectedAddress, date:timestamp})await addDoc(itemRef,{address:mail ,addressType:selectedAddress, date:timestamp})
