...
const AddScammer = () => {
    ...
    const addflag = async()=>{
        if (user!=null){
            //add to flag
            await addDoc(itemRef,{address:mail ,userId:user.uid,type:selectedAddress})
            //add to comments
            await addDoc(commentRef,{comment:comment ,userId:user.uid,address:mail})
        }
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.midContainer}>
            ...
            {/* <DropdownPicker /> */}
            <Picker
            style={[styles.dropdownPick, {marginTop: '25px',marginVertical:10,backgroundColor:'red'}]}
