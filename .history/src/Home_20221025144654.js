...
console.log(user);
//add remove flag vote
const addFlagID=async()=>{
  if (user == null) {
               ...
               flags.map(flag=>((
                ...
                <View style={styles.cardsContainer} key={flag.id}>
                  <View style={styles.card}>
                        ...
                        <View style={styles.userContainerRightBorder}>
                          ...
                          <TouchableOpacity onPress={() => 
                            ...
                            <View style={styles.comments}>
                              <Text style={styles.username2}><Likes/></Text><FontAwesomeIcon icon={faFlag} style={styles.flags} />
                        ...
                        <TouchableOpacity      onPress={addLike} style={styles.upvoteBtn}>
