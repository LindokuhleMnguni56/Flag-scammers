...
const AddScammer = () => {
    ...
    const addflag = async()=>{
        // if (user!=null){
            ...
            const docRef = await addDoc(itemRef,{address:mail ,addressType:selectedAddress, date:timestamp})await addDoc(itemRef,{address:mail ,addressType:selectedAddress, date:timestamp})
             await addDoc(commentRef,{comment:comment})
