 ...
 const user=auth.currentUser
  ...
  const getItems = async () => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      listFlag.push({ id: doc.id, address: doc.data().address, comment: doc.data().comments, date: doc.data().date, commentCount: commentCount,likesCount:likesCount, upvoted:l})
    });
    setFlags(listFlag)
    setLoading(false)
