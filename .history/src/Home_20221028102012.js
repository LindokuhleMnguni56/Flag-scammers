...
const months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Augus", "September", "October", "November", "December"];
const d = new Date();
                    ...
                    <View style={styles.card}>
                      <View style={styles.dateContainerBorder}>
                        <View style={styles.dateContainer}>
                          ...
                          {/* <Text style={styles.year}>{dateY.getFullYear()}</Text> */}
                          <Text style={styles.year}>{monthName}</Text>
                          {/* <Text style={styles.year}>{dateY.getDate()}</Text> */}
                        </View>
                      </View>
