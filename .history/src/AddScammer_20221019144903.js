...
import {userAppContext} from '../components/MyContext';
import DropdownPicker from '../components/dropdownpicker';


const AddScammer = () => {

    const [globalState, dispatch] = userAppContext();
    ...
    const addflag = async()=>{
        if (user!=null){
            await addDoc(itemRef,{address:mail ,comment:comment ,userId:user.uid,type:globalState   })
        }
