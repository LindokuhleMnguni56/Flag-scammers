 ...
 const user=auth.currentUser
  ...
  const getItems = async () => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      listFlag.push({ id: doc.id, address: doc.data().address, comment: doc.data().comments, date: doc.data().date, commentCount: commentCount,likeCount:likeCount })
    });
    setFlags(listFlag)
    setLoading(false)
                      ...
                      <View style={styles.userContainerRightBorder}>
                        <View style={styles.userContainer}>
                          ...
                          <View style={styles.comments}>
                            <Text style={styles.username2}>{flag.likeCount}</Text><FontAwesomeIcon icon={faFlag} style={styles.flags} />
